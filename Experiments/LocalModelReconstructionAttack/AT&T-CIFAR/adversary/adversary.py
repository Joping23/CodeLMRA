...
class Adversary:
    ...
    def settle_for_decode_evaluation(self):
        ...
        elif self.experiment == "adult" or self.experiment == "purchase_100" or self.experiment =="synthetic_reg" or self.experiment =="faces":
...
# decoding lr variable for each worker 
            #optimizer = torch.optim.Adam([model_initial], lr=self.lr)
            optimizer = torch.optim.LBFGS([model_initial], lr=0.1)
    ...
    def check_other_benchmark(self):
        ...
        for worker_id in range(self.num_workers):
            ...
            elif self.experiment == "adult" or self.experiment == "purchase_100" or self.experiment == "synthetic" or self.experiment == "cifar10" or self.experiment == "synthetic_reg" or self.experiment == "faces" :
