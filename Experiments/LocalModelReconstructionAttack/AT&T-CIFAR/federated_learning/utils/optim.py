...
def get_optimizer(optimizer_name, net, lr_initial=1e-1):
    """
    ...
    if optimizer_name == "adam":
        ...
        return optim.SGD([param for param in net.parameters() if param.requires_grad], lr=lr_initial, momentum=0)
