...
#from federated_learning.model.neural_network import NeuralLayer, ConvLayer
from federated_learning.model.neural_network_regression import NeuralLayer
...
def get_local_model_structure(model, local_data_dir):
    if model == "neuralReg" :
        ...
        return NeuralLayer(num_dimension, 256, 1), 1, num_dimension
        ...
        if model == "neural":
            return NeuralLayer(num_dimension, 16, num_classes), num_classes, num_dimension
