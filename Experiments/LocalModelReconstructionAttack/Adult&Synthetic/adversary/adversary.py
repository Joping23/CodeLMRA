...
class Adversary:
    ...
    def settle_for_decode_evaluation(self):
        ...
        elif self.experiment == "adult" or self.experiment == "purchase_100":
    ...
    def check_other_benchmark(self):
        ...
        for worker_id in range(self.num_workers):
            ...
            elif self.experiment == "adult" or self.experiment == "purchase_100" or self.experiment == "synthetic" or self.experiment == "cifar10":
